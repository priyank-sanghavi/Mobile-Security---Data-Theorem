...
- (NSSet *)dataTypesToRead {
    ...
    //HKCharacteristicType *name = [HKObjectType characteristicTypeForIdentifier:HK];
...
- (void)updateUsersAgeLabel {
    ...
    if (!dateOfBirth) {
        ...
        str = [NSString stringWithFormat:@"%@  %@", str, [NSNumberFormatter localizedStringFromNumber:@(usersAge) numberStyle:NSNumberFormatterNoStyle] ];
...
- (void)updateUsersHeightLabel {
    ...
    [self.healthStore aapl_mostRecentQuantitySampleOfType:heightType predicate:nil completion:^(HKQuantity *mostRecentQuantity, NSError *error) {
        if (!mostRecentQuantity) {
            ...
            NSString *str1 = @"HEIGHT(inches) is ";
            
            str = [NSString stringWithFormat:@"%@  %@  %@", str, str1, [NSNumberFormatter localizedStringFromNumber:@(usersHeight) numberStyle:NSNumberFormatterNoStyle] ];
...
- (void)updateUsersWeightLabel {
    ...
    [self.healthStore aapl_mostRecentQuantitySampleOfType:weightType predicate:nil completion:^(HKQuantity *mostRecentQuantity, NSError *error) {
        if (!mostRecentQuantity) {
            ...
            NSString *str1 = @"WEIGHT(pounds) is ";
            
            str = [NSString stringWithFormat:@"%@  %@  %@", str, str1, [NSNumberFormatter localizedStringFromNumber:@(usersWeight) numberStyle:NSNumberFormatterNoStyle] ];
